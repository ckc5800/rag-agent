...
- TTS(2025.09~)
    ...
    - 스트리밍 api 리팩토링
        ...
        **버전 (deprecated)**
        ...
        - 성과(정정): 같은 텍스트를 **양쪽 다 완주**시킨 비교 기준 **TTFB 1,943ms → 985ms (49% 단축)**.
        - 아래 로그의 2,292ms → 334ms(85.4%)는 **신버전 런이 "중지됨" 상태**라 완주 비교가 아니어서 대표값에서 제외함 (2026-08 정정)
        ...
        **신버전**
        ...
        - 샘플레이트: **24000 Hz**
        - 길이: **-**
        - 중지됨  ← **완주하지 않은 런.** 이 값(334ms)은 대표값으로 쓰지 않음
